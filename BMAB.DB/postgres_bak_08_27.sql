...
-- Name: BMAB; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE BMAB WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C';


ALTER DATABASE BMAB OWNER TO postgres;
